				...
				<div className="flex-1 flex flex-col ml-64">
					...
					<section className="flex-1 overflow-y-auto mt-16">
						<div className="max-w-7xl mx-auto px-8 py-12">
							...
							<div className="bg-white rounded-3xl shadow-2xl border border-gray-300 mb-12 overflow-hidden hover:shadow-3xl transition-all duration-500">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
								{/* Feature 1 */}
								<div className="group bg-white rounded-3xl shadow-xl border border-gray-300 p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:bg-white">
							...
							{/* Contact Section */}
							<div className="bg-white rounded-3xl shadow-2xl border border-gray-300 p-12 text-center">
								<h2 className="text-4xl font-bold text-gray-800 mb-6">Bắt Đầu Ngay Hôm Nay</h2>
								<p className="text-gray-600 text-xl mb-8 max-w-2xl mx-auto">
									Tham gia cộng đồng nghiên cứu và khám phá tiềm năng không giới hạn của bạn
								</p>
								<button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-2xl text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
									Khám Phá Ngay
								</button>
							</div>
						</div>
